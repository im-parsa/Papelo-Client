        ...
        <main>
            ...
            <section className={styles.aboutUsFeatures}>
                <div className='container border no-padding'>
                    <div>
                        ...
                        <h3>
                            ما در پاپلو برای انجام وظایفمان منتظر کلمه‌ها هستیم، نه دستورالعمل و نامه‌ی رسمی؛ درست مثل یک خانواده
                        </h3>
                    </div>
                    <div>
                        <i>
            ...
            <section className={styles.aboutUsContent}>
                ...
                <div className='container'>
                    ...
                    <h4>
                        پاپلو در بهمن ماه سال 1394 شروع به کار کرد و در ابتدا تنها وب سایتی برای رزرو آنلاین بلیط هواپیما ارزان قیمت بود. پس از چند ماه فعالیت و علاقه مندی و درخواست مشتریان، خدمات بلیط قطار و اتوبوس نیز برای اولین بار در ایران اضافه گردید. در پاپلو علاوه بر جستجوی کاملترین پروازهای داخلی می توانید ارزانترین قیمت ها را نیز پیدا کنید! خدمات رزرو آنلاین قطار و اتوبوس هر روز کامل تر می شود تا شما مجموعه کاملی از رزرو آنلاین بلیط داخلی را در پاپلو داشته باشید. ما به تجربه شما از خرید اینترنتی اهمیت می دهیم و تلاش ما برای داشتن خدماتی ساده، سریع و ارزان است
                    </h4>
                </div>
            </section>
            ...
            <section className={styles.aboutUsStory}>
                <div className='container border'>
                    ...
                    <h4>
                        {
                            story === 1
                                ? '                        پاپلو در بهمن ماه سال 1394 شروع به کار کرد و در ابتدا تنها وب سایتی برای رزرو آنلاین بلیط هواپیما ارزان قیمت بود. پس از چند ماه فعالیت و علاقه مندی و درخواست مشتریان، خدمات بلیط قطار و اتوبوس نیز برای اولین بار در ایران اضافه گردید. در پاپلو علاوه بر جستجوی کاملترین پروازهای داخلی می توانید ارزانترین قیمت ها را نیز پیدا کنید'
                                : story === 2
                                    ? '                        پاپلو در بهمن ماه سال 1394 شروع به کار کرد و در ابتدا تنها وب سایتی برای رزرو آنلاین بلیط هواپیما ارزان قیمت بود. پس از چند ماه فعالیت و علاقه مندی و درخواست مشتریان، خدمات بلیط قطار و اتوبوس نیز برای اولین بار در ایران اضافه گردید. در پاپلو علاوه بر جستجوی کاملترین پروازهای داخلی می توانید ارزانترین قیمت ها را نیز پیدا کنید'
                                    : story === 3
                                        ? '                        پاپلو در بهمن ماه سال 1394 شروع به کار کرد و در ابتدا تنها وب سایتی برای رزرو آنلاین بلیط هواپیما ارزان قیمت بود. پس از چند ماه فعالیت و علاقه مندی و درخواست مشتریان، خدمات بلیط قطار و اتوبوس نیز برای اولین بار در ایران اضافه گردید. در پاپلو علاوه بر جستجوی کاملترین پروازهای داخلی می توانید ارزانترین قیمت ها را نیز پیدا کنید'
