        ...
        <main>
            ...
            <section className={styles.aboutUsContent}>
                <div className='container'>
                    ...
                    <h4>
                        اسکای&zwnj;رو در بهمن ماه سال 1394 شروع به کار کرد و در ابتدا تنها وب سایتی برای رزرو آنلاین بلیط هواپیما ارزان قیمت بود. پس از چند ماه فعالیت و علاقه مندی و درخواست مشتریان، خدمات بلیط قطار و اتوبوس نیز برای اولین بار در ایران اضافه گردید. در اسکای&zwnj;رو علاوه بر جستجوی کاملترین پروازهای داخلی می توانید ارزانترین قیمت ها را نیز پیدا کنید! خدمات رزرو آنلاین قطار و اتوبوس هر روز کامل تر می شود تا شما مجموعه کاملی از رزرو آنلاین بلیط داخلی را در اسکای&zwnj;رو داشته باشید. ما به تجربه شما از خرید اینترنتی اهمیت می دهیم و تلاش ما برای داشتن خدماتی ساده، سریع و ارزان است
                    </h4>
                </div>
            </section>
                    ...
                    <h4>
                        {
                            story === 1
                                ?
                                '                        اسکای&zwnj;رو در بهمن ماه سال 1394 شروع به کار کرد و در ابتدا تنها وب سایتی برای رزرو آنلاین بلیط هواپیما ارزان قیمت بود. پس از چند ماه فعالیت و علاقه مندی و درخواست مشتریان، خدمات بلیط قطار و اتوبوس نیز برای اولین بار در ایران اضافه گردید. در اسکای&zwnj;رو علاوه بر جستجوی کاملترین پروازهای داخلی می توانید ارزانترین قیمت ها را نیز پیدا کنید'
                                :
                                story === 2
                                    ?
                                    '                        اسکای&zwnj;رو در بهمن ماه سال 1394 شروع به کار کرد و در ابتدا تنها وب سایتی برای رزرو آنلاین بلیط هواپیما ارزان قیمت بود. پس از چند ماه فعالیت و علاقه مندی و درخواست مشتریان، خدمات بلیط قطار و اتوبوس نیز برای اولین بار در ایران اضافه گردید. در اسکای&zwnj;رو علاوه بر جستجوی کاملترین پروازهای داخلی می توانید ارزانترین قیمت ها را نیز پیدا کنید'
