...
import TourTicket from '../../../components/tour-ticket/tour-ticket.component';
            ...
            <section className={styles.search}>
                <div className='container'>
                    ...
                    <div className={styles.searchContent}>
                        <aside className={styles.searchContentFilter}>
                            <header>
                        ...
                        <div className={styles.searchContentBoxes}>
                            <div className={styles.searchContentBoxesHeader}>
                                <h4>
                                    نتایج جستجو برای تورهای کیش

                                    <span>
                                        حدود 25 تور در کیش یافت شد
                                    </span>
                                </h4>
